...
<figure><img src="../../../.gitbook/assets/image (2).png" alt=""><figcaption><p>Both the original transformer as well as the ViT take unstructured data, convert it to numerical representations, and finally use that for tasks like classification.</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/image (3).png" alt=""><figcaption><p>Text is passed to one or multiple encoders by first tokenizing it using a tokenizer.</p></figcaption></figure>
